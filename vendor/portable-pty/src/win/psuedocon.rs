...
impl PsuedoCon {
    pub fn new(size: COORD, input: FileDescriptor, output: FileDescriptor) -> Result<Self, Error> {
        ...
        let result = unsafe {
            (CONPTY.CreatePseudoConsole)(
                ...
                // Note: PSUEDOCONSOLE_INHERIT_CURSOR (0x1) intentionally omitted.
                // It requires an async cursor-state handshake on hOutput/hInput
                // that we don't implement, causing ConPTY to hang in GUI apps.
                // See: https://github.com/microsoft/terminal/issues/17688
    ...
    pub fn spawn_command(&self, cmd: CommandBuilder) -> anyhow::Result<WinChild> {
        ...
        si.StartupInfo.wShowWindow = 0; // SW_HIDE: suppress phantom console window flash
