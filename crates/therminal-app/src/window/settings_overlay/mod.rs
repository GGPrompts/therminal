...
//!   `rebuild_widgets_section`, `rebuild_appearance_section`,
//!   `seed_defaults`),
...
//!   `BACKGROUND_OPACITY_OPTIONS`, `background_opacity_index`.
...
pub(crate) use sections::{
    ...
    UI_TEXT_SCALE_OPTIONS, background_opacity_index, bell_style_index, cursor_style_index,
    font_family_index, scrollback_index, ui_text_scale_index,
};
